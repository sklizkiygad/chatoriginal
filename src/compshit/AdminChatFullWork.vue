    ...
    export default {
        ...
        methods:{
            ...
            async getClients(){
                try{
                    ...
                    //const response=await axios.get(`${this.myProxy}/users/api/all`);
                    const response=await axios.get(`${this.myProxy}/api/users/all`);
        ...
        computed:{
            ...
            searchedList(){
             ...
             //let searchedClientList=this.clientDataList.filter(client=>client.name.includes(this.searchQuery));
                return [...this.clientDataList].filter(client=>client.name.toLowerCase().includes(this.searchQuery.toLowerCase()));
